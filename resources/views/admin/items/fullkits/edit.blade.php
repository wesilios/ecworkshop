	            			...
	            			<div style="min-height:600px; width:100%">
	                			<div class="nav-tabs-custom" style="height:100%">
					                <ul class="nav nav-tabs">
					                  	...
					                  	<li {{ $fullkit->medias->isNotEmpty() == 1 ? '' : 'class=active' }}><a href="#tab_2" data-toggle="tab">Media gallery</a></li>
					                  	<li {{ $fullkit->medias->isNotEmpty() == 1 ? 'class=active' : '' }}><a href="#tab_3" data-toggle="tab">Ảnh sản phẩm</a></li>
					                ...
					                <div class="tab-content">
							        		...
							        		<div class="box box-hidden">
												<div class="box-body">
													<div class="form-hidden">
									    				{!! Form::open(['method'=>'PUT', 'action'=>["AdminFullKitsController@uploadImage",$fullkit->id] ,'files'=>true]) !!}
							        	...
							        	<div class="tab-pane {{ $fullkit->medias->isNotEmpty() == 1 ? '' : 'active' }}" id="tab_2">
							        		<div class="box">
							        			<div class="box-body" >
							        	...
							        	<div class="tab-pane {{ $fullkit->medias->isNotEmpty() == 1 ? 'active' : '' }}" id="tab_3">
							        		<div class="box">
							        			<div class="box-body" >
													{!! Form::open(['method'=>'PUT', 'action'=>["AdminFullKitsController@set_image_index",$fullkit->id]]) !!}
														<div class="form-group">
