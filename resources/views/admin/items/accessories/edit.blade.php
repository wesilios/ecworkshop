...
@section('content')
	...
	@include('admin.items.accessories.include.media')
@endsection
...
@section('extendscripts')
	<script>
        ...
        $('.removeSelectedImg').click(function(e){
            ...
            {
                $.ajax({
                    url: "{{ route('admin.accessory.remove_selected_img') }}",
                    method:'POST',
                    dataType:'json',
                    data: {media_id:id, _token:token, accessory_id:accessory_id},
                    success: function(data) {
                        if(data.error) {
                            console.log(data.message);
                            window.location.reload(true);
                            console.log(data.accessory);
                            $('#selected_img').html('');
        ...
        $('#new_folder').click(function(e) {
            ...
            if(folder_name == '') {
                ...
                $.ajax({
                    url: "{{ route('admin.folder.createAccessoryAjax') }}",
                    method:'POST',
                    dataType:'json',
                    data: {folder_name:folder_name, _token:token, folder_id:folder_id, accessory_id:accessory_id},
                    success: function(data) {
                        if(data.error) {
        ...
        $('#formUploadImage').on('submit', function (e) {
            ...
            $.ajax({
                url: "{{ route('admin.accessory.ajaxUpload') }}",
                method: 'POST',
                dataType: 'json',
                contentType: false,
                cache: false,
