...
@section('content')
	...
	@include('admin.items.boxes.include.media')
	...
	<script>
        ...
        $('#new_folder').click(function(e) {
            ...
            if(folder_name == '') {
                ...
                $.ajax({
                    url: "{{ route('admin.folder.createBoxAjax') }}",
                    method:'POST',
                    dataType:'json',
                    data: {folder_name:folder_name, _token:token, folder_id:folder_id, box_id:box_id},
                    success: function(data) {
                        if(data.error) {
