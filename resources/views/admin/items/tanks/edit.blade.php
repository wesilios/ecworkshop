...
@section('content')
	...
	@include('admin.items.tanks.include.media')
@endsection
	...
	<script>
        ...
        $('#new_folder').click(function(e) {
            ...
            if(folder_name == '') {
                ...
                $.ajax({
                    url: "{{ route('admin.folder.createTankAjax') }}",
                    method:'POST',
                    dataType:'json',
                    data: {folder_name:folder_name, _token:token, folder_id:folder_id, tank_id:tank_id},
                    success: function(data) {
                        if(data.error) {
