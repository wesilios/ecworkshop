...
@section('content')
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li><a href="{{ route('users.index') }}"> Tất cả tài khoản</a></li>
        ...
        <div class="row">
				...
				<div class="box">
	                ...
	                <div class="box-body">
						...
						<div class="col-md-10 table-responsive no-padding">
			                ...
			                <a href="{{ route('users.edit', [$admin->id]) }}" class="btn btn-primary btn-sm pull-right"><i class="fa fa-edit"></i> Chỉnh sửa</a>
						</div>
	                </div>
	        ...
	        <div class="col-sm-6">
	        	<div class="box box-solid">
	                <div class="box-header with-border">
	                  	<h3 class="box-title"><i class="fa fa-file-text"></i> Bài viết <small>đăng bởi {{ $admin->name }}</small></h3>
	                </div><!-- /.box-header -->
	                <div class="box-body">
	        ...
	        <div class="col-sm-6">
	        	<div class="box box-solid">
	                <div class="box-header with-border">
	                  	<h3 class="box-title"><i class="fa fa-bookmark"></i> Sản phẩm <small>tạo bởi {{ $admin->name }}</small></h3>
	                </div><!-- /.box-header -->
	                <div class="box-body">
						<div class="col-sm-12 table-responsive no-padding">
							<table class="table table-hover">
